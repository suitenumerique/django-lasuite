...
@mock.patch("lasuite.oidc_resource_server.utils.import_private_key_from_settings")
def test_view_jwks_valid_public_key(mock_import_private_key_from_settings):
    ...
    assert all(private_detail not in jwks["keys"][0] for private_detail in private_details)
